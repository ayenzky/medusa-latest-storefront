...
import { SubscriptionIntervalType } from "types/global"
...
export async function updateSubscriptionData(
  subscription_interval: SubscriptionIntervalType,
...
export async function cancelSubscription(subscriptionId: string) {
  ...
  const subscription = await sdk.client.fetch(`/store/customers/me/subscriptions/${subscriptionId}`, {
    method: "post",
    headers,
  })
